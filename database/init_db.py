...
def create_tables(con):
    ...
    for _c, _d in [("code","股票代码"),("stock_name","股票名称"),("market","市场"),
        ...
        ("virtual_close_price","平仓交易价格"),
        ("virtual_close_price_after_slippage","平仓扣除滑点后的交易价格"),
        ("virtual_close_shares","平仓股数"),
        ("virtual_close_slippage","平仓滑点"),
        ("virtual_close_amount","平仓交易金额"),
        ("virtual_close_commission","平仓交易佣金"),
        ("virtual_close_pnl","平仓交易盈利"),
