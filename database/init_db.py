...
def create_tables(con):
    ...
    con.execute("""
        CREATE TABLE backtest_stats (
            ...
            virtual_close_price              DOUBLE,
            virtual_close_price_after_slippage DOUBLE,
            virtual_close_shares            DOUBLE,
            virtual_close_slippage          DOUBLE,
            virtual_close_amount             DOUBLE,
            virtual_close_commission         DOUBLE,
            virtual_close_pnl                DOUBLE,
    ...
    for _c, _d in [("code","股票代码"),("stock_name","股票名称"),("market","市场"),
        ...
        ("virtual_close_price","虚拟平仓交易价格"),
        ("virtual_close_price_after_slippage","虚拟平仓扣除滑点后的交易价格"),
        ("virtual_close_shares","虚拟平仓股数"),
        ("virtual_close_slippage","虚拟平仓滑点"),
        ("virtual_close_amount","虚拟平仓交易金额"),
        ("virtual_close_commission","虚拟平仓交易佣金"),
        ("virtual_close_pnl","虚拟平仓交易盈利"),
